...
const ContactMe = ({ pageInfo }: Props) => {
	...
	return (
		<div className='h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-full px-10 justify-evenly mx-aut0 items-center'>
			<h3 className='absolute top-24 md:top-16 uppercase tracking-[20px] text-gray-500 text-2xl'>
				Contact
			</h3>

			<div className='flex flex-col space-y-10 top-28 absolute p-6'>
